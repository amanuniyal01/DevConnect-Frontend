...
function Landing() {
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-blue-50 overflow-hidden">

         
            <div className="landing w-full h-64 sm:h-80 md:h-120 md:w-1/2 flex items-center justify-center" />
