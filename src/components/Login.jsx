...
function Login() {
    ...
    return (
        <div className='bg-blue-50 min-h-screen flex flex-col md:flex-row'>
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center px-6 py-12">
                ...
                <div className="bg-white rounded-2xl w-full max-w-sm overflow-hidden shadow-lg shadow-blue-100">
                    ...
                    <div className="bg-blue-600 px-8 py-8 text-center">
                        ...
                        <p className="text-blue-200 text-sm mt-1">Login to <span className="text-white font-semibold">DevConnect</span></p>
                    </div>
                    ...
                    <div className="px-8 py-7 flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <div className="flex items-center gap-2 border border-slate-200 rounded-xl px-3 bg-slate-50">
                                ...
                                <input type="email" placeholder="you@example.com"
                                    className="bg-transparent outline-none text-sm py-3 w-full text-slate-700 placeholder-slate-400" />
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className="btn bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl w-full border-none mt-1">
                            Login
                        </button>
